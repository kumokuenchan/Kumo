...
export default function DataViewer({
    ...
    return (
      <div className="flex items-center justify-center h-full">
        <div className="text-center">
          ...
          <p className="text-gray-700 dark:text-gray-300 text-sm mb-4">{(error as Error).message}</p>
          <button
  ...
  return (
    <div className="flex flex-col h-full bg-[#f9fbfa] dark:bg-[#0d1117]">
      {/* Toolbar */}
      <div className="bg-white dark:bg-[#161b22] border-b border-gray-200 dark:border-gray-800 px-2 py-1">
        <div className="flex items-center justify-between gap-3">
          {/* Left: Sort controls */}
          <div className="flex items-center gap-1.5">
            <div className="flex items-center gap-1.5 px-2 py-1 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded">
              <div className="w-3.5 h-3.5 bg-gradient-to-br from-green-500 to-green-600 rounded flex items-center justify-center">
                <svg className="w-2.5 h-2.5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 10h18M3 14h18m-9-4v8m-7 0h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
                </svg>
              </div>
              <span className="text-xs font-medium text-green-700 dark:text-green-300" title={`Table: ${table}`}>
                {table}
              </span>
            </div>

            <select
              className="px-1 py-1 text-xs border border-gray-300 dark:border-gray-700 rounded bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 max-w-[180px] focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500"
              value={sortColumn}
            ...
            <select
              className="px-2 py-1.5 text-sm border border-gray-300 dark:border-gray-700 rounded bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500"
              value={sortDirection}
            ...
            <button
              className="px-3 py-1.5 text-sm bg-green-600 hover:bg-green-700 text-white rounded font-medium transition"
              title="Apply sort"
              onClick={() => {
            ...
            <button
              className="px-3 py-1.5 text-sm border border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-300 rounded hover:bg-gray-50 dark:hover:bg-gray-800 font-medium transition"
              title="Clear sort"
            ...
            <div className="flex items-center gap-1">
              <button
                ...
                className="p-1.5 text-sm bg-green-600 hover:bg-green-700 text-white rounded transition"
                title="Add row"
              >
              ...
              <button
                ...
                className="p-1.5 text-sm bg-yellow-600 hover:bg-yellow-700 text-white rounded transition disabled:opacity-50 disabled:cursor-not-allowed"
              ...
              <button
                ...
                className="p-1.5 text-sm bg-red-600 hover:bg-red-700 text-white rounded transition disabled:opacity-50 disabled:cursor-not-allowed"
              ...
              <button
                ...
                className="p-1.5 text-sm bg-purple-600 hover:bg-purple-700 text-white rounded transition"
          ...
          <div className="flex items-center gap-1">
            <input
              ...
              className="px-3 py-1.5 text-sm border border-gray-300 dark:border-gray-700 rounded w-64 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500"
            />
            <button
            ...
            <button
              ...
              className={`p-1.5 text-sm rounded transition ${
                showFilters
            ...
            <div className="relative">
              ...
              {showColumnMenu && (
                <div className="absolute right-0 mt-1 w-80 sm:w-96 bg-white dark:bg-[#161b22] border border-gray-200 dark:border-gray-800 rounded shadow-lg z-10 max-h-96 overflow-y-auto">
                  <div className="p-2">
                    ...
                    <div className="flex items-center gap-2 mb-2 flex-wrap">
                      <input
                        ...
                        className="flex-1 px-2 py-1 text-xs border border-gray-300 dark:border-gray-700 rounded bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500"
                      />
                    ...
                    <div className="flex items-center gap-2 mb-2">
                      <button
                        ...
                        className="text-xs px-2 py-0.5 rounded border border-gray-300 text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:text-gray-200 dark:hover:bg-gray-800 transition"
                    ...
                    {(
                      ...
                      <label
                        key={column.id}
                        className="flex items-center gap-2 px-2 py-1.5 hover:bg-gray-50 dark:hover:bg-gray-800 rounded cursor-pointer transition"
                      >
                        <input
                          type="checkbox"
            ...
            <button
              ...
              className="p-1.5 text-sm bg-white text-gray-600 dark:text-gray-400 rounded hover:bg-gray-50 dark:hover:bg-gray-800 border border-gray-300 dark:border-gray-700 transition"
              title="Copy CSV"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button
              ...
              className="p-1.5 text-sm bg-white text-green-600 dark:text-green-400 rounded hover:bg-green-50 dark:hover:bg-green-900/20 border border-green-600 dark:border-green-700 transition"
              title="Import data"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button
              ...
              className="p-1.5 text-sm bg-white text-blue-600 dark:text-blue-400 rounded hover:bg-blue-50 dark:hover:bg-blue-900/20 border border-blue-600 dark:border-blue-700 transition"
              title="Export data"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {hasEdits && (
          <div className="flex items-center gap-2 mt-1">
            ...
            <button
              ...
              className="px-3 py-1 text-sm bg-green-600 hover:bg-green-700 text-white rounded font-medium transition disabled:opacity-50"
            ...
            <button
              ...
              className="px-3 py-1 text-sm border border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-300 rounded hover:bg-gray-50 dark:hover:bg-gray-800 font-medium transition"
        ...
        {(search || filters.length > 0 || sortBy.length > 0) && (
          <div className="mt-1 flex items-center gap-2 flex-wrap">
            {sortBy.length > 0 && sortBy.map((sort) => (
              <div
                key={sort.column}
                className="px-2 py-1 bg-green-100 text-green-800 dark:bg-green-900/40 dark:text-green-100 dark:border dark:border-green-800 text-xs font-medium rounded flex items-center gap-2"
              >
            ...
            {search && (
              <div className="px-2 py-1 bg-blue-100 text-blue-800 dark:bg-blue-900/40 dark:text-blue-100 dark:border dark:border-blue-800 text-xs font-medium rounded flex items-center gap-2">
            ...
            {filters.map((filter) => (
              <div
                key={filter.column}
                className="px-2 py-1 bg-blue-100 text-blue-800 dark:bg-blue-900/40 dark:text-blue-100 dark:border dark:border-blue-800 text-xs font-medium rounded flex items-center gap-2"
              >
      ...
      <div className="flex-1 min-w-0 overflow-hidden p-4 flex flex-col relative">
        {/* Loading Overlay */}
        {isLoading && (
          <div className="absolute inset-0 bg-[#f9fbfa] dark:bg-[#0d1117] bg-opacity-40 dark:bg-opacity-40 flex items-center justify-center z-50 backdrop-blur-sm">
            <div className="flex flex-col items-center gap-3 bg-white dark:bg-[#161b22] rounded-lg shadow-xl px-6 py-4 border-2 border-green-300 dark:border-green-800">
